# Active Record
Cycle ORM leaves enough room for developers to alter it behavior. In this section, we will try to create ActiveRecord implementation which is automatically configured based on database introspection. 
