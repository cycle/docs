...
> Table class will automatically run a query and return last inserted id. You can also check `insertMultiple` method of Table.

## SelectQuery Builder
SelectQuery builder can be retrieved two very similar ways, you can either get it from the database or the table instances:
