...
## Columns
No entity can operate without some properties mapped to table columns. To map your property to the column add annotation `@column` to it. It's mandratory to specify column type. You must always specify **one** primary (autogenerated) column for your entity.
